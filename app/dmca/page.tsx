...
// route and render it server-side so `/dmca` serves real, crawlable content
// (the marketing SPA only exposes it at the non-crawlable hash route `#/dmca`).
const DOC_ID = "dmca";

export const metadata: Metadata = {
  title: "DMCA Policy",
  description:
    "How VallaPOS responds to DMCA copyright takedown notices and counter-notifications.",
...
export default function DmcaPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <h1 className="mt-6 text-3xl font-black tracking-tight sm:text-4xl">DMCA Policy</h1>
