...
// route and render it server-side so `/disputes` serves real, crawlable content
// (the marketing SPA only exposes it at the non-crawlable hash route `#/disputes`).
const DOC_ID = "disputes";

export const metadata: Metadata = {
  title: "Dispute Policy",
  description: "How VallaPOS handles refunds, cancellations, billing disputes, and arbitration.",
...
export default function DisputesPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <h1 className="mt-6 text-3xl font-black tracking-tight sm:text-4xl">Dispute Policy</h1>
