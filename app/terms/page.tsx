...
// route and render it server-side so `/terms` serves real, crawlable content
// (the marketing SPA only exposes it at the non-crawlable hash route `#/terms`).
const DOC_ID = "terms";

export const metadata: Metadata = {
  title: "Terms of Use",
  description: "The terms governing your use of VallaPOS Cloud and VallaPOS Offline.",
...
function legalDocHtml(id: string): string {
  ...
  // Rewrite the SPA hash cross-links (`#/disputes`) to the real routes (`/disputes`).
