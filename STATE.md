...
_Last updated: 2026-07-13 — see the **"2026-07-13 — Editions Stages 3–7"** section just below for the newest work (offline edition data+auth+Tauri-seam+license+release scaffolding; #119–#125; the whole TS/build seam is done + tested, cloud unchanged; what's left needs the Rust/Tauri toolchain + signing certs). Older history follows unchanged._
